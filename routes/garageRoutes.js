...
import { registerGarage, viewGarages, updateGarage, deleteGarage, getGarageById, viewGarageRegistrations, approveGarageRegistration, rejectGarageRegistration, addStaff, viewStaff, disableStaff, enableStaff, getStaffById, disableGarage, enableGarage } from '../controller/garageController.js';
...
router.put("/garages/:id/enable", enableGarage);
router.put("/garages/:id/disable", disableGarage);
